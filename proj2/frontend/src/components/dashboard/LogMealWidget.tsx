...
interface LogMealWidgetProps {
  onLogMeal: () => void;
}

export function LogMealWidget({ onLogMeal }: LogMealWidgetProps) {
  return (
    <Card className="col-span-full border-2 border-dashed border-purple-300 bg-linear-to-br from-purple-50 to-pink-50 transition-all hover:border-purple-400 hover:shadow-lg lg:col-span-1">
      <CardContent className="flex flex-col items-center justify-center p-8 text-center">
        ...
        <Button size="lg" onClick={onLogMeal} className="gap-2 bg-purple-600 hover:bg-purple-700">
